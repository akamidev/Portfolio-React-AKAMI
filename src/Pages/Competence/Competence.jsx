...
function Tabs() {
  ...
  // La valeur initiale est récupérée à partir du localStorage ou définie sur 'Expériences' si aucune valeur n'est stockée.
  const [activeTab, setActiveTab] = useState(
    localStorage.getItem("activeTab") || "Expériences"
  );
